...
const Footer = ({ className = '' }: FooterProps) => {
  ...
  // Obtener el año actual solo en el cliente para evitar hydration mismatch
  useEffect(() => {
    setCurrentYear(new Date().getFullYear());
  }, []);

  return (
    <footer className={`bg-gradient-to-br from-[#1e3052] to-[#00529B] text-white ${className}`}>
      <Container>
          ...
          >
            ...
            <ul className="space-y-3">
              <li className="flex items-start text-gray-300 text-sm">
                <svg className="w-5 h-5 mr-2 flex-shrink-0 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:contato@ksc.com.br" className="hover:text-white transition-colors">
                  contato@ksc.com.br
                </a>
              </li>
              <li className="flex items-start text-gray-300 text-sm">
        ...
        <div className="py-6 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          >
            <a href="/privacidade" className="text-gray-300 hover:text-white transition-colors text-sm">
              Política de Privacidade
            </a>
            <span className="text-gray-600">|</span>
            <a href="/termos" className="text-gray-300 hover:text-white transition-colors text-sm">
              Termos de Uso
            </a>
            <span className="text-gray-600">|</span>
            <a href="/cookies" className="text-gray-300 hover:text-white transition-colors text-sm">
              Cookies
            </a>
          </motion.div>
        </div>

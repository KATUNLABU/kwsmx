            ...
            <div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-purple-500 hover:shadow-xl transition-shadow duration-300">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                        href="tel:+551198173942"
                        className="text-purple-600 hover:text-purple-700 font-semibold text-lg block mb-1"
                      >
                        +55 (11) 98173-9425
                      </a>
                      <a
              ...
              <div className="mt-10 p-6 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl border border-green-200">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    href="https://wa.me/5511981739425"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm opacity-90">+55 (11) 98173-9425</div>
                    </div>
                  </a>
